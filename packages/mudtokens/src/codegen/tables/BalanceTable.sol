...
library BalanceTable {
  ...
  /** Get value */
  function get(bytes32 _tableId, address owner) internal view returns (uint256 value) {
  ...
  function get(IStore _store, bytes32 _tableId, address owner) internal view returns (uint256 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
  ...
  /** Set value */
  function set(bytes32 _tableId, address owner, uint256 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
  ...
  function set(IStore _store, bytes32 _tableId, address owner, uint256 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
