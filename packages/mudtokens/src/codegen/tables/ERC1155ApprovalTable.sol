...
library ERC1155ApprovalTable {
  ...
  /** Get value */
  function get(bytes32 _tableId, address owner, address operator) internal view returns (bool value) {
  ...
  function get(IStore _store, bytes32 _tableId, address owner, address operator) internal view returns (bool value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
    _keyTuple[1] = bytes32(uint256(uint160(operator)));
  ...
  /** Set value */
  function set(bytes32 _tableId, address owner, address operator, bool value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
    _keyTuple[1] = bytes32(uint256(uint160(operator)));
  ...
  function set(IStore _store, bytes32 _tableId, address owner, address operator, bool value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
    _keyTuple[1] = bytes32(uint256(uint160(operator)));
